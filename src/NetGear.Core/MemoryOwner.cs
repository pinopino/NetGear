...
namespace NetGear.Core
{
    public static class MemoryOwner
    {
        ...
        /// </summary>
        public static IMemoryOwner<char> DecodeWithOwnership(this ReadOnlyMemory<byte> bytes, Encoding encoding = null)
        {
            if (encoding == null)
        ...
        /// </summary>
        public static IMemoryOwner<byte> EncodeWithOwnership(this string value, Encoding encoding = null)
        {
            if (encoding == null)
                encoding = Encoding.UTF8;
